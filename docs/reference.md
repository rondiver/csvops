...
[← Overview and quick start](../README.md) · [Worked example](../examples/README.md)

Run the examples from the repository root, or replace the input path with your own CSV. For built-in help:
